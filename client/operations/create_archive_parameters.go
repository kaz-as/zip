...
CreateArchiveParams contains all the parameters to send to the API endpoint
	...
	for the create archive operation.
...
// WithDefaults hydrates default values in the create archive params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateArchiveParams) WithDefaults() *CreateArchiveParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create archive params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateArchiveParams) SetDefaults() {
...
// WithFiles adds the files to the create archive params
func (o *CreateArchiveParams) WithFiles(files models.FilesForArchive) *CreateArchiveParams {
	o.SetFiles(files)
	return o
}

// SetFiles adds the files to the create archive params
func (o *CreateArchiveParams) SetFiles(files models.FilesForArchive) {
	o.Files = files
}
