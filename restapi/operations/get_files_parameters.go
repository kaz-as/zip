...
// GetFilesParams contains all the bound params for the get files operation
// typically these are obtained from a http.Request
//
// swagger:parameters getFiles
...
//
// To ensure default values, the struct must have been initialized with NewGetFilesParams() beforehand.
func (o *GetFilesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetFilesParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
